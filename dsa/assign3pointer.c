   ...
   do{
    ...
    for(i=0;*(a+i)!='\0';i++)
       ...
       for(k=i,l=0;k<(i+j);l++,k++)
       {
        ...
        scanf("%d",&k);
        printf("\nenter the index to which you want to find substring from string 1\n");
        scanf("%d",&l);
        if(k>i||l>i||k>l)
        {
            printf("\nplease check it should be les than length of string and second no. less than first\n");
        }
        else
        {
        ...
        scanf("%d",&l);
         if(k>l)
        {
        printf("\nplease check it should be less than length of string and second no. less than first\n");
